...
To force the browser to add vertical spacing, wrap the paragraphs you 
...
tag to tell browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        My favorite recipe: Make cookies
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <textarea id="wd-textarea" cols={30} rows={10}>Lorem Ipsum is simply dummy
        ...
        <h4>Anchor tag Example</h4>
        Please
        <a id="wd-github" href="https://github.com/ICE-CUBA/kanbas-react-web-app-24fall.git">click here</a>
        to get github website<br/>
