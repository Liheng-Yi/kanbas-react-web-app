...
export default function KanbasNavigation() {
  ...
  const links = [
    { id: "dashboard", label: "Dashboard", path: "/Kanbas/Dashboard", icon: AiOutlineDashboard },
    { id: "courses", label: "Courses", path: "/Kanbas/Courses", icon: LiaBookSolid },
    { id: "calendar", label: "Calendar", path: "/Kanbas/Calendar", icon: IoCalendarOutline },
    { id: "inbox", label: "Inbox", path: "/Kanbas/Inbox", icon: FaInbox },
